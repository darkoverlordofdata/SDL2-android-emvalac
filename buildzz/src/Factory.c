/** updated by adriac */
/* Factory.c generated by valac 0.34.9, the Vala compiler
...
// symtbl.3 SdxAudioSound / sdx_audio_sound
SdxAudioSound* sdx_audio_sound_retain (SdxAudioSound* self);
void sdx_audio_sound_release (SdxAudioSound* self);
...
EntitasEntity* factory_CreateBullet (Factory* self) {
	...
	_tmp1_ = sdx_files_Resource ("assets/sounds/pew.wav");
	_tmp2_ = _tmp1_;
...
EntitasEntity* factory_CreateExplosion (Factory* self) {
	...
	_tmp1_ = sdx_files_Resource ("assets/sounds/asplode.wav");
	_tmp2_ = _tmp1_;
	_tmp3_ = sdx_audio_sound_new (_tmp2_);
	_tmp4_ = _tmp3_;
	_tmp5_ = entitas_entity_AddSound (_tmp0_, _tmp4_);
...
EntitasEntity* factory_CreateBang (Factory* self) {
	...
	_tmp1_ = sdx_files_Resource ("assets/sounds/smallasplode.wav");
	_tmp2_ = _tmp1_;
	_tmp3_ = sdx_audio_sound_new (_tmp2_);
	_tmp4_ = _tmp3_;
	_tmp5_ = entitas_entity_AddSound (_tmp0_, _tmp4_);
...
void factory_AddParticle (Factory* self, gint x, gint y) {
	...
	guint _tmp19_ = 0U;
	EntitasTransform _tmp20_ = {0};
	SDL_Rect* _tmp21_ = NULL;
	guint _tmp22_ = 0U;
	EntitasEntity* _tmp23_ = NULL;
	gint _tmp24_ = 0;
	gint _tmp25_ = 0;
