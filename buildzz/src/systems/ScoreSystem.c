/** updated by adriac */
/* ScoreSystem.c generated by valac 0.34.9, the Vala compiler
...
static void __lambda72_ (Block37Data* _data37_, gfloat delta);
...
static void __lambda73_ (SystemsScoreSystem* self, EntitasEntity* entity);
...
static void ___lambda72__entitas_system_execute (gfloat delta, gpointer self);
...
static void block37_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data37_->_ref_count_)) {
		SystemsScoreSystem* self;
		self = _data37_->self;
		_entitas_group_release0 (_data37_->scoring);
...
static void ___lambda73__gfunc (gconstpointer data, gpointer self) {
	__lambda73_ ((SystemsScoreSystem*) self, data);
}
...
static void __lambda72_ (Block37Data* _data37_, gfloat delta) {
	...
	GList* _tmp0_ = NULL;
	self = _data37_->self;
	_tmp0_ = _data37_->scoring->entities;
	g_list_foreach (_tmp0_, ___lambda73__gfunc, self);
}


static void ___lambda72__entitas_system_execute (gfloat delta, gpointer self) {
	__lambda72_ (self, delta);
}
...
SystemsScoreSystem* systems_score_system_new (Game* game, Factory* world) {
	...
	_data37_->self = entitas_system_retain (self);
	_tmp0_ = world;
	...
	((EntitasSystem*) self)->Execute = ___lambda72__entitas_system_execute;
	((EntitasSystem*) self)->Execute_target = block37_data_ref (_data37_);
	((EntitasSystem*) self)->Execute_target_destroy_notify = block37_data_unref;
