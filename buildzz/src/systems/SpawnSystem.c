/** updated by adriac */
/* SpawnSystem.c generated by valac 0.34.9, the Vala compiler
...
static gfloat __lambda52_ (Block39Data* _data39_, gfloat delta, gfloat t, gint enemy);
...
static gfloat ___lambda52__systems_spawn_system_spawn_enemy_func (gfloat delta, gfloat t, gint enemy, gpointer self);
static void __lambda53_ (Block39Data* _data39_, gfloat delta);
static void ___lambda53__entitas_system_execute (gfloat delta, gpointer self);
...
static gfloat ___lambda52__systems_spawn_system_spawn_enemy_func (gfloat delta, gfloat t, gint enemy, gpointer self) {
	gfloat result;
	result = __lambda52_ (self, delta, t, enemy);
	return result;
}
...
SystemsSpawnSystem* systems_spawn_system_new (Game* game, Factory* world) {
	...
	_data39_->SpawnEnemy = ___lambda52__systems_spawn_system_spawn_enemy_func;
	...
	((EntitasSystem*) self)->Execute = ___lambda53__entitas_system_execute;
