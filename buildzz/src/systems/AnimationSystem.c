/** updated by adriac */
/* AnimationSystem.c generated by valac 0.34.9, the Vala compiler
...
static void __lambda66_ (Block27Data* _data27_, gfloat delta);
...
static void __lambda67_ (Block28Data* _data28_, EntitasEntity* entity);
gboolean entitas_entity_IsActive (EntitasEntity *self);
static void ___lambda67__gfunc (gconstpointer data, gpointer self);
static void ___lambda66__entitas_system_execute (gfloat delta, gpointer self);
...
static void __lambda67_ (Block28Data* _data28_, EntitasEntity* entity) {
	...
	if (_tmp0_) {
		...
		EntitasTransform _tmp41_ = {0};
		SdxMathVector2* _tmp42_ = NULL;
		gfloat _tmp43_ = 0.0F;
		EntitasEntity* _tmp44_ = NULL;
		EntitasTransform _tmp45_ = {0};
		SdxMathVector2* _tmp46_ = NULL;
		gfloat _tmp47_ = 0.0F;
		EntitasEntity* _tmp48_ = NULL;
		EntitasTween* _tmp49_ = NULL;
...
static void __lambda66_ (Block27Data* _data27_, gfloat delta) {
	...
	g_list_foreach (_tmp1_, ___lambda67__gfunc, _data28_);
...
SystemsAnimationSystem* systems_animation_system_new (Game* game, Factory* world) {
	...
	((EntitasSystem*) self)->Execute = ___lambda66__entitas_system_execute;
