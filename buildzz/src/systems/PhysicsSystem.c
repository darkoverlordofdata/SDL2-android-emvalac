/** updated by adriac */
/* PhysicsSystem.c generated by valac 0.34.9, the Vala compiler
...
static void __lambda61_ (Block34Data* _data34_, gfloat delta);
...
static void __lambda62_ (Block35Data* _data35_, EntitasEntity* it);
...
static void ___lambda62__gfunc (gconstpointer data, gpointer self);
static void ___lambda61__entitas_system_execute (gfloat delta, gpointer self);
...
static void __lambda61_ (Block34Data* _data34_, gfloat delta) {
	...
	g_list_foreach (_tmp1_, ___lambda62__gfunc, _data35_);
...
SystemsPhysicsSystem* systems_physics_system_new (Game* game, Factory* world) {
	...
	((EntitasSystem*) self)->Execute = ___lambda61__entitas_system_execute;
