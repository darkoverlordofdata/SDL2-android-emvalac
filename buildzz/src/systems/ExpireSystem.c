/** updated by adriac */
/* ExpireSystem.c generated by valac 0.34.9, the Vala compiler
...
static void __lambda68_ (Block31Data* _data31_, gfloat delta);
...
static void __lambda69_ (Block32Data* _data32_, EntitasEntity* entity);
...
static void ___lambda69__gfunc (gconstpointer data, gpointer self);
static void ___lambda68__entitas_system_execute (gfloat delta, gpointer self);
...
static void __lambda68_ (Block31Data* _data31_, gfloat delta) {
	...
	g_list_foreach (_tmp1_, ___lambda69__gfunc, _data32_);
...
SystemsExpireSystem* systems_expire_system_new (Game* game, Factory* world) {
	...
	((EntitasSystem*) self)->Execute = ___lambda68__entitas_system_execute;
