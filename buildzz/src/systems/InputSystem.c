/** updated by adriac */
/* InputSystem.c generated by valac 0.34.9, the Vala compiler
...
// symtbl.3 EntitasSystem / entitas_system
EntitasSystem* entitas_system_retain (EntitasSystem* self);
void entitas_system_release (EntitasSystem* self);
...
static void __lambda54_ (Block33Data* _data33_, gfloat delta);
...
static void ___lambda54__entitas_system_execute (gfloat delta, gpointer self);
void sdx_input_processor_free (SdxInputProcessor* self);
...
static gboolean __lambda55_ (Block33Data* _data33_, gint keycode);
static gboolean ___lambda55__sdx_input_processor_input_processor_key_down (gint keycode, gpointer self);
...
static gboolean __lambda56_ (Block33Data* _data33_, gint keycode);
static gboolean ___lambda56__sdx_input_processor_input_processor_key_up (gint keycode, gpointer self);
...
static gboolean __lambda57_ (Block33Data* _data33_, gint screenX, gint screenY, gint pointer, gint button);
static gboolean ___lambda57__sdx_input_processor_input_processor_touch_down (gint x, gint y, gint pointer, gint button, gpointer self);
...
static gboolean __lambda58_ (Block33Data* _data33_, gint screenX, gint screenY, gint pointer, gint button);
static gboolean ___lambda58__sdx_input_processor_input_processor_touch_up (gint x, gint y, gint pointer, gint button, gpointer self);
...
static gboolean __lambda59_ (Block33Data* _data33_, gint screenX, gint screenY, gint pointer);
static gboolean ___lambda59__sdx_input_processor_input_processor_touch_dragged (gint x, gint y, gint pointer, gpointer self);
...
static gboolean __lambda60_ (Block33Data* _data33_, gint screenX, gint screenY);
static gboolean ___lambda60__sdx_input_processor_input_processor_mouse_moved (gint x, gint y, gpointer self);
...
static gboolean ___lambda55__sdx_input_processor_input_processor_key_down (gint keycode, gpointer self) {
	gboolean result;
	result = __lambda55_ (self, keycode);
	return result;
}
...
static gboolean ___lambda56__sdx_input_processor_input_processor_key_up (gint keycode, gpointer self) {
	gboolean result;
	result = __lambda56_ (self, keycode);
	return result;
}
...
static gboolean ___lambda57__sdx_input_processor_input_processor_touch_down (gint x, gint y, gint pointer, gint button, gpointer self) {
	gboolean result;
	result = __lambda57_ (self, x, y, pointer, button);
	return result;
}
...
static gboolean ___lambda58__sdx_input_processor_input_processor_touch_up (gint x, gint y, gint pointer, gint button, gpointer self) {
	gboolean result;
	result = __lambda58_ (self, x, y, pointer, button);
	return result;
}
...
static gboolean ___lambda59__sdx_input_processor_input_processor_touch_dragged (gint x, gint y, gint pointer, gpointer self) {
	gboolean result;
	result = __lambda59_ (self, x, y, pointer);
	return result;
}
...
SystemsInputSystem* systems_input_system_new (Game* game, Factory* world) {
	...
	SdxInputProcessor* _tmp10_ = NULL;
	SdxInputProcessor* _tmp11_ = NULL;
	SdxInputProcessor* _tmp12_ = NULL;
	SdxInputProcessor* _tmp13_ = NULL;
	SdxInputProcessor* _tmp14_ = NULL;
	SdxInputProcessor* _tmp15_ = NULL;
	SdxInputProcessor* _tmp16_ = NULL;
	SdxInputProcessor* _tmp17_ = NULL;
	SdxInputProcessor* _tmp18_ = NULL;
	SdxInputProcessor* _tmp19_ = NULL;
	SdxInputProcessor* _tmp20_ = NULL;
	SdxInputProcessor* _tmp21_ = NULL;
	SdxInputProcessor* _tmp22_ = NULL;
	...
	((EntitasSystem*) self)->Execute = ___lambda54__entitas_system_execute;
	...
	_tmp10_ = _tmp9_;
	_tmp11_ = sdx_input_processor_SetKeyDown (_tmp10_, ___lambda55__sdx_input_processor_input_processor_key_down, _data33_);
	_tmp12_ = _tmp11_;
	_tmp13_ = sdx_input_processor_SetKeyUp (_tmp12_, ___lambda56__sdx_input_processor_input_processor_key_up, _data33_);
	_tmp14_ = _tmp13_;
	_tmp15_ = sdx_input_processor_SetTouchDown (_tmp14_, ___lambda57__sdx_input_processor_input_processor_touch_down, _data33_);
	_tmp16_ = _tmp15_;
	_tmp17_ = sdx_input_processor_SetTouchUp (_tmp16_, ___lambda58__sdx_input_processor_input_processor_touch_up, _data33_);
	_tmp18_ = _tmp17_;
	_tmp19_ = sdx_input_processor_SetTouchDragged (_tmp18_, ___lambda59__sdx_input_processor_input_processor_touch_dragged, _data33_);
	_tmp20_ = _tmp19_;
	_tmp21_ = sdx_input_processor_SetMouseMoved (_tmp20_, ___lambda60__sdx_input_processor_input_processor_mouse_moved, _data33_);
	_tmp22_ = _tmp21_;
