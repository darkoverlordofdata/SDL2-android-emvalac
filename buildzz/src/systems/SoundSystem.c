/** updated by adriac */
/* SoundSystem.c generated by valac 0.34.9, the Vala compiler
 * generated from SoundSystem.vala, do not modify */
...
struct _Block38Data {
	int _ref_count_;
	SystemsSoundSystem* self;
	EntitasGroup* effects;
};
...
static void __lambda70_ (Block38Data* _data38_, gfloat delta);
...
static void __lambda71_ (SystemsSoundSystem* self, EntitasEntity* entity);
gboolean entitas_entity_IsActive (EntitasEntity *self);
void sdx_audio_sound_Play (SdxAudioSound* self, gint loops);
static void ___lambda71__gfunc (gconstpointer data, gpointer self);
static void ___lambda70__entitas_system_execute (gfloat delta, gpointer self);
...
static void block38_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data38_->_ref_count_)) {
		SystemsSoundSystem* self;
		self = _data38_->self;
		_entitas_group_release0 (_data38_->effects);
...
static void __lambda71_ (SystemsSoundSystem* self, EntitasEntity* entity) {
	...
	if (_tmp0_) {
		...
		_tmp2_ = (*_tmp1_).sound;
		_tmp3_ = (*_tmp2_).sound;
		sdx_audio_sound_Play (_tmp3_, 0);
	}
}


static void ___lambda71__gfunc (gconstpointer data, gpointer self) {
	__lambda71_ ((SystemsSoundSystem*) self, data);
}
...
static void __lambda70_ (Block38Data* _data38_, gfloat delta) {
	...
	GList* _tmp0_ = NULL;
	self = _data38_->self;
	_tmp0_ = _data38_->effects->entities;
	g_list_foreach (_tmp0_, ___lambda71__gfunc, self);
}


static void ___lambda70__entitas_system_execute (gfloat delta, gpointer self) {
	__lambda70_ (self, delta);
}
...
SystemsSoundSystem* systems_sound_system_new (Game* game, Factory* world) {
	...
	self = (SystemsSoundSystem*) entitas_system_new ();
	_data38_->self = entitas_system_retain (self);
	_tmp0_ = world;
	_tmp1_ = g_new0 (gint, 1);
	_tmp1_[0] = (gint) ENTITAS_COMPONENTS_SoundComponent;
	_tmp2_ = _tmp1_;
	_tmp2__length1 = 1;
	...
	((EntitasSystem*) self)->Execute = ___lambda70__entitas_system_execute;
