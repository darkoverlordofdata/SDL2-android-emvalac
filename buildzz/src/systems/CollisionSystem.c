/** updated by adriac */
/* CollisionSystem.c generated by valac 0.34.9, the Vala compiler
...
static void __lambda63_ (Block29Data* _data29_, gfloat delta);
...
static void __lambda64_ (Block29Data* _data29_, EntitasEntity* enemy);
...
static void ___lambda65_ (Block30Data* _data30_, EntitasEntity* bullet);
...
static void ____lambda65__gfunc (gconstpointer data, gpointer self);
static void ___lambda64__gfunc (gconstpointer data, gpointer self);
static void ___lambda63__entitas_system_execute (gfloat delta, gpointer self);
...
static void __lambda64_ (Block29Data* _data29_, EntitasEntity* enemy) {
	...
	if (_tmp1_) {
		...
		g_list_foreach (_tmp2_, ____lambda65__gfunc, _data30_);
	}
...
static void __lambda63_ (Block29Data* _data29_, gfloat delta) {
	...
	g_list_foreach (_tmp0_, ___lambda64__gfunc, _data29_);
}


static void ___lambda63__entitas_system_execute (gfloat delta, gpointer self) {
	__lambda63_ (self, delta);
}
...
SystemsCollisionSystem* systems_collision_system_new (Game* game, Factory* world) {
	...
	((EntitasSystem*) self)->Execute = ___lambda63__entitas_system_execute;
