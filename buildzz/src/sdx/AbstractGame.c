/** updated by adriac */
/* AbstractGame.c generated by valac 0.34.9, the Vala compiler
...
void sdx_abstract_reference_release (SdxAbstractReference* self);
void sdx_abstract_reference_free (SdxAbstractReference* self);
// symtbl.3 SdxAbstractReference / sdx_abstract_reference
SdxAbstractReference* sdx_abstract_reference_retain (SdxAbstractReference* self);
void sdx_abstract_reference_release (SdxAbstractReference* self);
...
static void _sdx_abstract_platform_update_lambda125_ (gint tick);
static void __sdx_abstract_platform_update_lambda125__sdx_abstract_platform_abstract_update (gint tick, gpointer self);
static void _sdx_abstract_platform_draw_lambda126_ (gint tick);
static void __sdx_abstract_platform_draw_lambda126__sdx_abstract_platform_abstract_draw (gint tick, gpointer self);
...
void sdx_abstract_platform_free (SdxAbstractPlatform* self);
// symtbl.3 SdxAbstractPlatform / sdx_abstract_platform
SdxAbstractPlatform* sdx_abstract_platform_retain (SdxAbstractPlatform* self);
void sdx_abstract_platform_release (SdxAbstractPlatform* self);
...
SdxAbstractGame* sdx_abstract_game_new (void) {
	...
	SdxAbstractReference* _tmp0_ = NULL;
...
static void __sdx_abstract_platform_update_lambda125__sdx_abstract_platform_abstract_update (gint tick, gpointer self) {
	_sdx_abstract_platform_update_lambda125_ (tick);
}
...
static void __sdx_abstract_platform_draw_lambda126__sdx_abstract_platform_abstract_draw (gint tick, gpointer self) {
	_sdx_abstract_platform_draw_lambda126_ (tick);
}
...
static void sdx_abstract_platform_instance_init (SdxAbstractPlatform * self) {
	self->ref_count = 1;
	self->Update = __sdx_abstract_platform_update_lambda125__sdx_abstract_platform_abstract_update;
	self->Update_target = self;
	self->Update_target_destroy_notify = NULL;
	self->Draw = __sdx_abstract_platform_draw_lambda126__sdx_abstract_platform_abstract_draw;
	self->Draw_target = self;
	self->Draw_target_destroy_notify = NULL;
}
