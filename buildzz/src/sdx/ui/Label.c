/** updated by adriac */
/* Label.c generated by valac 0.34.9, the Vala compiler
...
// symtbl.3 SdxUiContainer / sdx_ui_container
SdxUiContainer* sdx_ui_container_retain (SdxUiContainer* self);
void sdx_ui_container_release (SdxUiContainer* self);
...
// symtbl.3 SdxUiLabel / sdx_ui_label
SdxUiLabel* sdx_ui_label_retain (SdxUiLabel* self);
void sdx_ui_label_release (SdxUiLabel* self);
...
// symtbl.3 SdxUiLabelNinePatch / sdx_ui_label_nine_patch
...
SdxUiLabelNinePatch* sdx_ui_label_nine_patch_new (const gchar* text, SdxFont* font, SDL_Color fg, SdxGraphicsNinePatch* bg) {
	...
	SDL_Color _tmp4_ = {0};
	SDL_Color* _tmp5_ = NULL;
	SdxGraphicsNinePatch* _tmp6_ = NULL;
	const gchar* _tmp7_ = NULL;
	SdxFont* _tmp8_ = NULL;
	SDL_Color* _tmp9_ = NULL;
	SdxGraphicsSpriteUISprite* _tmp10_ = NULL;
