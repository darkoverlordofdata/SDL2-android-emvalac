...
namespace Sdx.Graphics 
{
     ...
     */
    [Compact, CCode ( /** reference counting */
    	ref_function = "sdx_graphics_page_retain", 
    	unref_function = "sdx_graphics_page_release"
    )]
    public class Page {
    	public int ref_count = 1;
     ...
     */
    [Compact, CCode ( /** reference counting */
    	ref_function = "sdx_graphics_region_retain", 
    	unref_function = "sdx_graphics_region_release"
    )]
    public class Region {
    	public int ref_count = 1;
    ...
    [Compact, CCode ( /** reference counting */
    	ref_function = "sdx_graphics_texture_atlas_data_retain", 
    	unref_function = "sdx_graphics_texture_atlas_data_release"
    )]
