/** updated by adriac */
/* Surface.c generated by valac 0.34.9, the Vala compiler
...
// symtbl.3 SdxGraphicsSurface / sdx_graphics_surface
SdxGraphicsSurface* sdx_graphics_surface_retain (SdxGraphicsSurface* self);
void sdx_graphics_surface_release (SdxGraphicsSurface* self);
...
void sdx_files_file_handle_free (SdxFilesFileHandle* self);
// symtbl.3 SdxGraphicsSurfaceCachedSurface / sdx_graphics_surface_cached_surface
