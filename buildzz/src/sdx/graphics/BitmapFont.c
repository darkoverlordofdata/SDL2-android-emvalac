/** updated by adriac */
/* BitmapFont.c generated by valac 0.34.9, the Vala compiler
...
void sdx_graphics_bitmap_font_free (SdxGraphicsBitmapFont* self);
// symtbl.3 SdxGraphicsBitmapFont / sdx_graphics_bitmap_font
SdxGraphicsBitmapFont* sdx_graphics_bitmap_font_retain (SdxGraphicsBitmapFont* self);
void sdx_graphics_bitmap_font_release (SdxGraphicsBitmapFont* self);
...
// symtbl.3 SdxGraphicsGlyph / sdx_graphics_glyph
SdxGraphicsGlyph* sdx_graphics_glyph_retain (SdxGraphicsGlyph* self);
void sdx_graphics_glyph_release (SdxGraphicsGlyph* self);
...
void sdx_graphics_bitmap_font_data_release (SdxGraphicsBitmapFontData* self);
void sdx_graphics_bitmap_font_data_free (SdxGraphicsBitmapFontData* self);
// symtbl.3 SdxGraphicsBitmapFontData / sdx_graphics_bitmap_font_data
SdxGraphicsBitmapFontData* sdx_graphics_bitmap_font_data_retain (SdxGraphicsBitmapFontData* self);
void sdx_graphics_bitmap_font_data_release (SdxGraphicsBitmapFontData* self);
...
void sdx_graphics_bitmap_font_data_Load (SdxGraphicsBitmapFontData* self, SdxFilesFileHandle* fontFile, gboolean flip) {
	...
	SdxUtilsJsVariant* _tmp41_ = NULL;
	gdouble _tmp42_ = 0.0;
	gint baseLine = 0;
	...
	SdxUtilsJsVariant* _tmp56_ = NULL;
	...
	SdxUtilsJsVariant* _tmp100_ = NULL;
	GList* _tmp101_ = NULL;
	GList* _tmp102_ = NULL;
	...
	self->imagePaths_length1 = _tmp62_;
	{
		...
		p = 0;
		{
			...
			while (TRUE) {
				...
				SdxUtilsJsVariant* _tmp72_ = NULL;
				...
				SdxUtilsJsVariant* _tmp80_ = NULL;
				...
				SdxFilesFileHandle* _tmp88_ = NULL;
				const gchar* _tmp89_ = NULL;
				SdxFilesFileHandle* _tmp90_ = NULL;
				SdxFilesFileHandle* _tmp91_ = NULL;
				gchar* _tmp92_ = NULL;
				gchar* _tmp93_ = NULL;
				if (!_tmp64_) {
					gint _tmp65_ = 0;
	...
	_sdx_utils_js_variant_release0 (_tmp96_);
	{
		...
		for (ch_it = ch_collection; ch_it != NULL; ch_it = ch_it->next) {
			SdxUtilsJsVariant* _tmp103_ = NULL;
			...
			ch = _tmp103_;
			{
				...
				if (_tmp164_ > 0) {
					SdxGraphicsGlyph* _tmp165_ = NULL;
					gint _tmp166_ = 0;
					_tmp165_ = glyph;
				...
				if (_tmp162_) {
					gint _tmp167_ = 0;
					SdxGraphicsGlyph* _tmp168_ = NULL;
					gint _tmp169_ = 0;
	...
	if (_tmp175_ == NULL) {
		...
		SdxGraphicsGlyph* _tmp182_ = NULL;
		gint _tmp183_ = 0;
	...
	if (_tmp186_ == 0) {
		SdxGraphicsGlyph* _tmp187_ = NULL;
		gfloat _tmp188_ = 0.0F;
		SdxGraphicsGlyph* _tmp189_ = NULL;
		gint _tmp190_ = 0;
		gfloat _tmp191_ = 0.0F;
		SdxGraphicsGlyph* _tmp192_ = NULL;
	...
	if (_tmp209_ == NULL) {
						...
						g = 0;
						{
							...
							while (TRUE) {
								...
								if (_tmp223_ == NULL) {
									...
									SdxGraphicsGlyph* _tmp224_ = NULL;
									gint _tmp225_ = 0;
									_tmp224_ = glyph;
								...
								if (_tmp222_) {
									...
									SdxGraphicsGlyph* _tmp226_ = NULL;
									gint _tmp227_ = 0;
									_tmp226_ = glyph;
		...
		SdxGraphicsGlyph* _tmp232_ = NULL;
		gint _tmp233_ = 0;
		_tmp232_ = capGlyph;
