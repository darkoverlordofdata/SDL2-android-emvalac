...
namespace Sdx.Graphics 
{
    ...
    [Compact, CCode ( /** reference counting */
    	ref_function = "sdx_graphics_bitmap_font_retain", 
    	unref_function = "sdx_graphics_bitmap_font_release"
    )]
    ...
    [Compact, CCode ( /** reference counting */
    	ref_function = "sdx_graphics_glyph_retain", 
    	unref_function = "sdx_graphics_glyph_release"
    )]
    public class Glyph {
    	public int ref_count = 1;
        ...
        public void SetKerning(int ch, int value) {
            ...
            kerning[i,j] = (char)value;
                ...
                [Compact, CCode ( /** reference counting */
                	ref_function = "sdx_graphics_bitmap_font_data_retain", 
                	unref_function = "sdx_graphics_bitmap_font_data_release"
                )]
