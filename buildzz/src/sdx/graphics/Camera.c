/** updated by adriac */
/* Camera.c generated by valac 0.34.9, the Vala compiler
...
static void _sdx_graphics_camera_set_position_lambda127_ (SdxMathVector2* position);
static void __sdx_graphics_camera_set_position_lambda127__sdx_graphics_camera_camera_set_position (SdxMathVector2* position, gpointer self);
...
void sdx_graphics_camera_free (SdxGraphicsCamera* self);
// symtbl.3 SdxGraphicsCamera / sdx_graphics_camera
SdxGraphicsCamera* sdx_graphics_camera_retain (SdxGraphicsCamera* self);
void sdx_graphics_camera_release (SdxGraphicsCamera* self);
SdxGraphicsCamera* sdx_graphics_camera_new (void);
// symtbl.3 SdxGraphicsCameraInnerCamera / sdx_graphics_camera_inner_camera
SdxGraphicsCameraInnerCamera* sdx_graphics_camera_inner_camera_new (gfloat x, gfloat y);
static void __lambda128_ (SdxGraphicsCameraInnerCamera* self, SdxMathVector2* player);
gfloat sdx_math_Clamp (gfloat value, gfloat low, gfloat hi);
static void ___lambda128__sdx_graphics_camera_camera_set_position (SdxMathVector2* position, gpointer self);
// symtbl.3 SdxGraphicsCameraFluidCamera / sdx_graphics_camera_fluid_camera
SdxGraphicsCameraFluidCamera* sdx_graphics_camera_fluid_camera_new (gfloat x, gfloat y);
static void __lambda129_ (SdxGraphicsCameraFluidCamera* self, SdxMathVector2* player);
static void ___lambda129__sdx_graphics_camera_camera_set_position (SdxMathVector2* position, gpointer self);
// symtbl.3 SdxGraphicsCameraSimpleCamera / sdx_graphics_camera_simple_camera
SdxGraphicsCameraSimpleCamera* sdx_graphics_camera_simple_camera_new (gfloat x, gfloat y);
static void __lambda130_ (SdxGraphicsCameraSimpleCamera* self, SdxMathVector2* player);
static void ___lambda130__sdx_graphics_camera_camera_set_position (SdxMathVector2* position, gpointer self);
...
static void __sdx_graphics_camera_set_position_lambda127__sdx_graphics_camera_camera_set_position (SdxMathVector2* position, gpointer self) {
	_sdx_graphics_camera_set_position_lambda127_ (position);
}
...
static void ___lambda128__sdx_graphics_camera_camera_set_position (SdxMathVector2* position, gpointer self) {
	__lambda128_ ((SdxGraphicsCameraInnerCamera*) self, position);
}
...
SdxGraphicsCameraInnerCamera* sdx_graphics_camera_inner_camera_new (gfloat x, gfloat y) {
	...
	((SdxGraphicsCamera*) self)->SetPosition = ___lambda128__sdx_graphics_camera_camera_set_position;
...
static void ___lambda129__sdx_graphics_camera_camera_set_position (SdxMathVector2* position, gpointer self) {
	__lambda129_ ((SdxGraphicsCameraFluidCamera*) self, position);
}
...
SdxGraphicsCameraFluidCamera* sdx_graphics_camera_fluid_camera_new (gfloat x, gfloat y) {
	...
	((SdxGraphicsCamera*) self)->SetPosition_target = NULL;
	((SdxGraphicsCamera*) self)->SetPosition_target_destroy_notify = NULL;
	((SdxGraphicsCamera*) self)->SetPosition = ___lambda129__sdx_graphics_camera_camera_set_position;
	((SdxGraphicsCamera*) self)->SetPosition_target = sdx_graphics_camera_retain (self);
	((SdxGraphicsCamera*) self)->SetPosition_target_destroy_notify = sdx_graphics_camera_release;
	return self;
}
...
static void ___lambda130__sdx_graphics_camera_camera_set_position (SdxMathVector2* position, gpointer self) {
	__lambda130_ ((SdxGraphicsCameraSimpleCamera*) self, position);
}
...
SdxGraphicsCameraSimpleCamera* sdx_graphics_camera_simple_camera_new (gfloat x, gfloat y) {
	...
	((SdxGraphicsCamera*) self)->SetPosition_target = NULL;
	((SdxGraphicsCamera*) self)->SetPosition_target_destroy_notify = NULL;
	((SdxGraphicsCamera*) self)->SetPosition = ___lambda130__sdx_graphics_camera_camera_set_position;
	((SdxGraphicsCamera*) self)->SetPosition_target = sdx_graphics_camera_retain (self);
	((SdxGraphicsCamera*) self)->SetPosition_target_destroy_notify = sdx_graphics_camera_release;
	return self;
}
...
static void sdx_graphics_camera_instance_init (SdxGraphicsCamera * self) {
	self->ref_count = 1;
	self->SetPosition = __sdx_graphics_camera_set_position_lambda127__sdx_graphics_camera_camera_set_position;
