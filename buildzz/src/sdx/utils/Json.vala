...
namespace Sdx.Utils 
{
    ...
    [Compact, CCode ( /** reference counting */
    	ref_function = "sdx_utils_json_retain", 
    	unref_function = "sdx_utils_json_release"
    )]
    public class Json {
     ...
     */
    [Compact, CCode ( /** reference counting */
    	ref_function = "sdx_utils_js_variant_retain", 
    	unref_function = "sdx_utils_js_variant_release"
    )]
