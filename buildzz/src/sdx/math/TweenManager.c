/** updated by adriac */
/* TweenManager.c generated by valac 0.34.9, the Vala compiler
...
// symtbl.3 SdxMathTweenManager / sdx_math_tween_manager
SdxMathTweenManager* sdx_math_tween_manager_retain (SdxMathTweenManager* self);
void sdx_math_tween_manager_release (SdxMathTweenManager* self);
...
static void ___lambda124_ (Block26Data* _data26_, SdxMathTweenbase* it);
void sdx_math_tweenbase_Update (SdxMathTweenbase* self, gfloat delta);
static void ____lambda124__gfunc (gconstpointer data, gpointer self);
...
SdxMathTweenManager* sdx_math_tween_manager_Add (SdxMathTweenManager* self, SdxMathTweenbase* object) {
	...
	if (_tmp4_) {
		...
		SdxMathTweenbaseTweenStart _tmp6_ = NULL;
...
static void ___lambda124_ (Block26Data* _data26_, SdxMathTweenbase* it) {
	...
	_tmp0_ = it;
	_tmp1_ = _data26_->delta;
	sdx_math_tweenbase_Update (_tmp0_, _tmp1_);
}


static void ____lambda124__gfunc (gconstpointer data, gpointer self) {
	___lambda124_ (self, (SdxMathTweenbase*) data);
}
...
void sdx_math_tween_manager_Update (SdxMathTweenManager* self, gfloat delta) {
	...
	_data26_->self = sdx_math_tween_manager_retain (self);
	_tmp0_ = delta;
	_data26_->delta = _tmp0_;
	_tmp1_ = self->objects;
	...
	if (!_tmp4_) {
		...
		_tmp5_ = self->objects;
		g_ptr_array_foreach (_tmp5_, ____lambda124__gfunc, _data26_);
	}
	block26_data_unref (_data26_);
	_data26_ = NULL;
}
