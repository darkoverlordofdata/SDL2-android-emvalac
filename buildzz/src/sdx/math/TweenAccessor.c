/** updated by adriac */
/* TweenAccessor.c generated by valac 0.34.9, the Vala compiler
...
static gint _sdx_math_tween_accessor_get_values_lambda74_ (void* target, gint type, gfloat** values, int* values_length1);
static gint __sdx_math_tween_accessor_get_values_lambda74__sdx_math_tween_accessor_get_values (void* target, gint tweenType, gfloat** returnValues, int* returnValues_length1, gpointer self);
static void _sdx_math_tween_accessor_set_values_lambda75_ (void* target, gint type, gfloat** values, int* values_length1);
static void __sdx_math_tween_accessor_set_values_lambda75__sdx_math_tween_accessor_set_values (void* target, gint tweenType, gfloat** newValues, int* newValues_length1, gpointer self);
...
void sdx_math_tween_accessor_free (SdxMathTweenAccessor* self);
// symtbl.3 SdxMathTweenAccessor / sdx_math_tween_accessor
SdxMathTweenAccessor* sdx_math_tween_accessor_retain (SdxMathTweenAccessor* self);
void sdx_math_tween_accessor_release (SdxMathTweenAccessor* self);
...
static gint __sdx_math_tween_accessor_get_values_lambda74__sdx_math_tween_accessor_get_values (void* target, gint tweenType, gfloat** returnValues, int* returnValues_length1, gpointer self) {
	gint result;
	result = _sdx_math_tween_accessor_get_values_lambda74_ (target, tweenType, returnValues, returnValues_length1);
	return result;
}
...
static void __sdx_math_tween_accessor_set_values_lambda75__sdx_math_tween_accessor_set_values (void* target, gint tweenType, gfloat** newValues, int* newValues_length1, gpointer self) {
	_sdx_math_tween_accessor_set_values_lambda75_ (target, tweenType, newValues, newValues_length1);
}
...
static void sdx_math_tween_accessor_instance_init (SdxMathTweenAccessor * self) {
	self->ref_count = 1;
	self->GetValues = __sdx_math_tween_accessor_get_values_lambda74__sdx_math_tween_accessor_get_values;
	self->GetValues_target = self;
	self->GetValues_target_destroy_notify = NULL;
	self->SetValues = __sdx_math_tween_accessor_set_values_lambda75__sdx_math_tween_accessor_set_values;
