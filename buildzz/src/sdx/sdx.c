...
// symtbl.3 SdxInputMultiplexer / sdx_input_multiplexer
SdxInputMultiplexer* sdx_input_multiplexer_retain (SdxInputMultiplexer* self);
void sdx_input_multiplexer_release (SdxInputMultiplexer* self);
...
SDL_Window* sdx_Initialize (gint width, gint height, const gchar* name) {
	...
	SDL_Color _tmp34_ = {0};
	SDL_Color* _tmp35_ = NULL;
	guint64 _tmp36_ = 0ULL;
	SdxInputMultiplexer* _tmp37_ = NULL;
...
void sdx_SetTweenManager (SdxMathTweenManager* manager) {
	...
	SdxMathTweenManager* _tmp1_ = NULL;
...
void sdx_AddInputProcessor (SdxInputProcessor* processor) {
	SdxInputMultiplexer* _tmp0_ = NULL;
...
void sdx_GameLoop (SdxAbstractGame* game) {
	...
	gdouble _tmp5_ = 0.0;
	gdouble _tmp6_ = 0.0;
	SdxAbstractGame* _tmp13_ = NULL;
	SdxAbstractGameAbstractDraw _tmp14_ = NULL;
	...
	while (TRUE) {
		gdouble _tmp7_ = 0.0;
		SdxMathTweenManager* _tmp8_ = NULL;
		SdxAbstractGame* _tmp10_ = NULL;
		SdxAbstractGameAbstractUpdate _tmp11_ = NULL;
		...
		if (_tmp8_ != NULL) {
			SdxMathTweenManager* _tmp9_ = NULL;
	...
	while (TRUE) {
		...
		switch (_tmp3_) {
			...
			case SDL_KEYDOWN:
			{
				...
				SdxInputMultiplexer* _tmp13_ = NULL;
				_tmp5_ = sdx_evt;
				_tmp6_ = _tmp5_.key;
				...
				if (sdx_input_multiplexer_KeyDown != NULL) {
					SdxInputMultiplexer* _tmp14_ = NULL;
					SDL_Event _tmp15_ = {0};
			...
			case SDL_KEYUP:
			{
				...
				SdxInputMultiplexer* _tmp28_ = NULL;
				_tmp20_ = sdx_evt;
				_tmp21_ = _tmp20_.key;
				...
				if (sdx_input_multiplexer_KeyUp != NULL) {
					SdxInputMultiplexer* _tmp29_ = NULL;
					SDL_Event _tmp30_ = {0};
					SDL_KeyboardEvent _tmp31_ = {0};
					SDL_Keysym _tmp32_ = {0};
					SDL_Keycode _tmp33_ = 0;
			...
			{
				SdxInputMultiplexer* _tmp34_ = NULL;
				_tmp34_ = sdx_inputProcessor;
				if (sdx_input_multiplexer_MouseMoved != NULL) {
					SdxInputMultiplexer* _tmp35_ = NULL;
					SDL_Event _tmp36_ = {0};
					SDL_MouseMotionEvent _tmp37_ = {0};
					gint32 _tmp38_ = 0;
					SDL_Event _tmp39_ = {0};
					SDL_MouseMotionEvent _tmp40_ = {0};
					gint32 _tmp41_ = 0;
			...
			{
				SdxInputMultiplexer* _tmp42_ = NULL;
				_tmp42_ = sdx_inputProcessor;
				if (sdx_input_multiplexer_TouchDown != NULL) {
					SdxInputMultiplexer* _tmp43_ = NULL;
					SDL_Event _tmp44_ = {0};
					SDL_MouseMotionEvent _tmp45_ = {0};
					gint32 _tmp46_ = 0;
					SDL_Event _tmp47_ = {0};
					SDL_MouseMotionEvent _tmp48_ = {0};
					gint32 _tmp49_ = 0;
			...
			{
				SdxInputMultiplexer* _tmp51_ = NULL;
				_tmp51_ = sdx_inputProcessor;
				if (sdx_input_multiplexer_TouchUp != NULL) {
					SdxInputMultiplexer* _tmp52_ = NULL;
					SDL_Event _tmp53_ = {0};
					SDL_MouseMotionEvent _tmp54_ = {0};
					gint32 _tmp55_ = 0;
					SDL_Event _tmp56_ = {0};
					SDL_MouseMotionEvent _tmp57_ = {0};
					gint32 _tmp58_ = 0;
			...
			{
				SdxInputMultiplexer* _tmp60_ = NULL;
				_tmp60_ = sdx_inputProcessor;
				if (sdx_input_multiplexer_TouchDragged != NULL) {
					SdxInputMultiplexer* _tmp61_ = NULL;
					SDL_Event _tmp62_ = {0};
					SDL_TouchFingerEvent _tmp63_ = {0};
					gfloat _tmp64_ = 0.0F;
					SDL_Event _tmp65_ = {0};
					SDL_TouchFingerEvent _tmp66_ = {0};
					gfloat _tmp67_ = 0.0F;
			...
			case SDL_FINGERDOWN:
			{
				SdxInputMultiplexer* _tmp68_ = NULL;
				_tmp68_ = sdx_inputProcessor;
				if (sdx_input_multiplexer_TouchDown != NULL) {
					SdxInputMultiplexer* _tmp69_ = NULL;
					SDL_Event _tmp70_ = {0};
					SDL_TouchFingerEvent _tmp71_ = {0};
					gfloat _tmp72_ = 0.0F;
					SDL_Event _tmp73_ = {0};
					SDL_TouchFingerEvent _tmp74_ = {0};
					gfloat _tmp75_ = 0.0F;
			...
			case SDL_FINGERUP:
			{
				SdxInputMultiplexer* _tmp76_ = NULL;
				_tmp76_ = sdx_inputProcessor;
				if (sdx_input_multiplexer_TouchUp != NULL) {
					SdxInputMultiplexer* _tmp77_ = NULL;
					SDL_Event _tmp78_ = {0};
					SDL_TouchFingerEvent _tmp79_ = {0};
					gfloat _tmp80_ = 0.0F;
					SDL_Event _tmp81_ = {0};
					SDL_TouchFingerEvent _tmp82_ = {0};
					gfloat _tmp83_ = 0.0F;
