...
[Compact, CCode ( /** reference counting */
	ref_function = "klass_retain", 
	unref_function = "klass_release"
)]
public class Klass {
	public int ref_count = 1;
	public unowned Klass retain() {
 ...
 */
[Compact, CCode ( /** reference counting */
	ref_function = "class_retain", 
	unref_function = "class_release"
)]
public class Class {
	public int ref_count = 1;
	public unowned Class retain() {
		GLib.AtomicInt.add (ref ref_count, 1);
		return this;
	}
	public void release() { 
