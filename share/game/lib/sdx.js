...
#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~
 */
var Atlas, Audio, Color, Files, Font, Game, Graphics, Sound, Sprite, VAtlas, VAtlasPtr, VAudio, VAudioPtr, VColor, VColorPtr, VFileHandler, VFileHandlerPtr, VFiles, VFilesPtr, VFont, VFontPtr, VGame, VGamePtr, VGraphics, VGraphicsPtr, VSound, VSoundPtr, VSprite, VSpritePtr, VText, VTextPtr, VWindow, VWindowPtr, ValaProxy, ffi, ref, sdx,
...
Object.defineProperties(sdx, {
  ...
  CreateWindow: {
    value: function(h, w, s) {
      return sdx.sdx_CreateWindow(h, w, s);
    }
  }
});
