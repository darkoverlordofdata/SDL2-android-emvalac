...
#   Vala Objects/Ptrs
#
VWindow = ref.types.void
VWindowPtr = ref.refType(VWindow)
...
sdx = ffi.Library 'sdx', 
    ...
    sdx_CreateWindow: [VWindow, ['int', 'int', 'string']]
...
Object.defineProperties sdx, 
    get_version:        value:() -> sdx.sdx_get_version()
    CreateWindow:      value:(h, w, s) -> sdx.sdx_CreateWindow(h, w, s)
