...
#define __g_list_free__util_string_release0_0(var) ((var == NULL) ? NULL : (var = (_g_list_free__util_string_release0_ (var), NULL)))
...
static void _util_string_release0_ (gpointer var) {
	(var == NULL) ? NULL : (var = (util_string_release (var), NULL));
}


static void _g_list_free__util_string_release0_ (GList* self) {
	g_list_foreach (self, (GFunc) _util_string_release0_, NULL);
	g_list_free (self);
}
...
void util_file_free (utilFile* self) {
	...
	_g_free0 (self->path);
	self->files = (_vala_array_free (self->files, self->files_length1, (GDestroyNotify) g_free), NULL);
	__g_list_free__util_string_release0_0 (self->fileList);
