...
#define _entitas_entity_cache_release0(var) ((var == NULL) ? NULL : (var = (entitas_entity_cache_release (var), NULL)))
...
void entitas_world_setPool (entitasWorld* self, gint size, gint count, entitasBuffer* buffers, int buffers_length1) {
	...
	entitasEntity* _tmp1_ = NULL;
	gint _tmp2_ = 0;
	entitasEntityCache** _tmp3_ = NULL;
	g_return_if_fail (self != NULL);
	_tmp0_ = size;
	...
	_tmp2_ = count;
	_tmp3_ = g_new0 (entitasEntityCache*, _tmp2_ + 1);
	self->cache = (_vala_array_free (self->cache, self->cache_length1, (GDestroyNotify) entitas_entity_cache_release), NULL);
	self->cache = _tmp3_;
	self->cache_length1 = _tmp2_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				gint _tmp15_ = 0;
				entitasEntityCache** _tmp16_ = NULL;
				gint _tmp16__length1 = 0;
				gint _tmp17_ = 0;
				entitasEntityCache* _tmp18_ = NULL;
				entitasEntityCache* _tmp19_ = NULL;
				if (!_tmp4_) {
					gint _tmp5_ = 0;
					_tmp5_ = i;
					i = _tmp5_ + 1;
				...
				_tmp17_ = iPool;
				_tmp18_ = entitas_entity_cache_new (4);
				_entitas_entity_cache_release0 (_tmp16_[_tmp17_]);
				...
				_tmp19_ = _tmp16_[_tmp17_];
				{
					...
					k = 0;
					{
						...
						while (TRUE) {
							gint _tmp22_ = 0;
							gint _tmp23_ = 0;
							entitasEntityCache** _tmp24_ = NULL;
							gint _tmp24__length1 = 0;
							gint _tmp25_ = 0;
							entitasEntityCache* _tmp26_ = NULL;
							...
							entitas_entity_cache_enque (_tmp26_, _tmp31_);
						}
					}
				}
			}
...
entitasWorld* entitas_world_addSystem (entitasWorld* self, entitasSystem* system) {
	...
	gint _tmp1_ = 0;
	entitasSystem* _tmp2_ = NULL;
	entitasISystem _tmp3_ = {0};
	entitasISystem _tmp4_ = {0};
	entitasISystem* _tmp5_ = NULL;
	...
	self->count = _tmp1_ + 1;
	_tmp2_ = system;
	_tmp3_ = entitas_system_get__ISystem (_tmp2_);
	_tmp4_ = _tmp3_;
	_tmp5_ = _entitas_isystem_dup0 (&_tmp4_);
	_entitas_isystem_free0 (_tmp0_[_tmp1_]);
	_tmp0_[_tmp1_] = _tmp5_;
	_tmp6_ = _tmp0_[_tmp1_];
	_tmp7_ = _entitas_world_retain0 (self);
	result = _tmp7_;
	return result;
}
...
void entitas_world_deleteEntity (entitasWorld* self, entitasEntity* entity) {
	...
	_tmp4_ = entity;
	entitas_entity_cache_enque (_tmp3_, _tmp4_);
