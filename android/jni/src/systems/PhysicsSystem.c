...
systemsPhysicsSystem* systems_physics_system_retain (systemsPhysicsSystem* self) {
	systemsPhysicsSystem* result = NULL;
...
void systems_physics_system_release (systemsPhysicsSystem* self) {
	...
	if (_tmp0_) {
		systems_physics_system_free (self);
	}
}
...
systemsPhysicsSystem* systems_physics_system_new (Game* game, Factory* world) {
	...
	self = g_slice_new0 (systemsPhysicsSystem);
	systems_physics_system_instance_init (self);
	_tmp0_ = game;
...
void systems_physics_system_initialize (systemsPhysicsSystem* self) {
	...
	_entitas_group_release0 (self->physics);
	self->physics = _tmp5_;
...
void systems_physics_system_free (systemsPhysicsSystem* self) {
	...
	_entitas_world_release0 (self->world);
	_entitas_group_release0 (self->physics);
	g_slice_free (systemsPhysicsSystem, self);
}
