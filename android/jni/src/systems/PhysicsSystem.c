...
static void __lambda11_ (Block6Data* _data6_, gfloat delta);
...
static void ___lambda11__entitas_system_execute (gfloat delta, gpointer self);
...
static void block6_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data6_->_ref_count_)) {
		systemsPhysicsSystem* self;
		self = _data6_->self;
		_entitas_group_release0 (_data6_->physics);
...
static void __lambda11_ (Block6Data* _data6_, gfloat delta) {
	...
	GList* _tmp0_ = NULL;
	self = _data6_->self;
	_tmp0_ = _data6_->physics->entities;
	{
		...
		for (entity_it = entity_collection; entity_it != NULL; entity_it = entity_it->next) {
			...
			entity = entity_it->data;
			{
				...
				if (_tmp1_) {
					...
					_tmp13_ = (*_tmp12_).y;
					_tmp14_ = entity;
					_tmp15_ = (*_tmp14_).velocity;
					_tmp16_ = (*_tmp15_).y;
					_tmp17_ = delta;
					y = _tmp13_ + (_tmp16_ * _tmp17_);
					_tmp18_ = x;
					_tmp19_ = y;
					entitas_entity_setPosition (entity, _tmp18_, _tmp19_);
				}
			}
		}
	}
...
systemsPhysicsSystem* systems_physics_system_new (Game* game, Factory* world) {
	...
	_data6_->self = entitas_system_retain (self);
	_tmp0_ = world;
	...
	((entitasSystem*) self)->execute = ___lambda11__entitas_system_execute;
	((entitasSystem*) self)->execute_target = block6_data_ref (_data6_);
	((entitasSystem*) self)->execute_target_destroy_notify = block6_data_unref;
