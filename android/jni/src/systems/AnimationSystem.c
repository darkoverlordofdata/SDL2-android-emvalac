...
systemsAnimationSystem* systems_animation_system_retain (systemsAnimationSystem* self) {
	systemsAnimationSystem* result = NULL;
...
void systems_animation_system_release (systemsAnimationSystem* self) {
	...
	if (_tmp0_) {
		systems_animation_system_free (self);
	}
}
...
systemsAnimationSystem* systems_animation_system_new (Game* game, Factory* world) {
	...
	self = g_slice_new0 (systemsAnimationSystem);
	systems_animation_system_instance_init (self);
	_tmp0_ = game;
...
void systems_animation_system_initialize (systemsAnimationSystem* self) {
	...
	_entitas_group_release0 (self->tweens);
	self->tweens = _tmp5_;
...
void systems_animation_system_free (systemsAnimationSystem* self) {
	...
	_entitas_world_release0 (self->world);
	_entitas_group_release0 (self->tweens);
	g_slice_free (systemsAnimationSystem, self);
}
