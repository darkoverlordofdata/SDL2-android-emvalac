...
static void __lambda13_ (Block2Data* _data2_, gfloat delta);
...
static void ___lambda13__entitas_system_execute (gfloat delta, gpointer self);
...
static void block2_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data2_->_ref_count_)) {
		systemsAnimationSystem* self;
		self = _data2_->self;
		_entitas_group_release0 (_data2_->tweens);
...
static void __lambda13_ (Block2Data* _data2_, gfloat delta) {
	...
	GList* _tmp0_ = NULL;
	self = _data2_->self;
	_tmp0_ = _data2_->tweens->entities;
	{
		...
		for (entity_it = entity_collection; entity_it != NULL; entity_it = entity_it->next) {
			...
			entity = entity_it->data;
			{
				...
				if (_tmp1_) {
					...
					_tmp10_ = entity;
					_tmp11_ = (*_tmp10_).transform;
					_tmp12_ = _tmp11_.scale;
					_tmp13_ = (*_tmp12_).y;
					_tmp14_ = entity;
					_tmp15_ = (*_tmp14_).tween;
					_tmp16_ = (*_tmp15_).speed;
					_tmp17_ = delta;
					y = _tmp13_ + (_tmp16_ * _tmp17_);
					_tmp18_ = entity;
					_tmp19_ = (*_tmp18_).tween;
					_tmp20_ = (*_tmp19_).active;
					active = _tmp20_;
					_tmp21_ = x;
					_tmp22_ = entity;
					...
					if (_tmp21_ > _tmp24_) {
						...
						entitasTween* _tmp26_ = NULL;
						gfloat _tmp27_ = 0.0F;
						entitasEntity* _tmp28_ = NULL;
						entitasTween* _tmp29_ = NULL;
						gfloat _tmp30_ = 0.0F;
						_tmp25_ = entity;
						_tmp26_ = (*_tmp25_).tween;
						_tmp27_ = (*_tmp26_).max;
						x = _tmp27_;
						_tmp28_ = entity;
						_tmp29_ = (*_tmp28_).tween;
						_tmp30_ = (*_tmp29_).max;
						y = _tmp30_;
						active = FALSE;
					} else {
						...
						if (_tmp31_ < _tmp34_) {
							...
							entitasTween* _tmp36_ = NULL;
							gfloat _tmp37_ = 0.0F;
							entitasEntity* _tmp38_ = NULL;
							entitasTween* _tmp39_ = NULL;
							gfloat _tmp40_ = 0.0F;
							_tmp35_ = entity;
							_tmp36_ = (*_tmp35_).tween;
							_tmp37_ = (*_tmp36_).min;
							x = _tmp37_;
							_tmp38_ = entity;
							_tmp39_ = (*_tmp38_).tween;
							_tmp40_ = (*_tmp39_).min;
							y = _tmp40_;
							active = FALSE;
						}
					...
					_tmp41_ = entity;
					_tmp42_ = (*_tmp41_).transform;
					_tmp43_ = _tmp42_.scale;
					_tmp44_ = x;
					(*_tmp43_).x = (gfloat) _tmp44_;
					_tmp45_ = entity;
					_tmp46_ = (*_tmp45_).transform;
					_tmp47_ = _tmp46_.scale;
					_tmp48_ = y;
					(*_tmp47_).y = (gfloat) _tmp48_;
					_tmp49_ = entity;
					_tmp50_ = (*_tmp49_).tween;
					_tmp51_ = active;
					(*_tmp50_).active = _tmp51_;
				}
			}
		}
	}
...
systemsAnimationSystem* systems_animation_system_new (Game* game, Factory* world) {
	...
	_data2_->self = entitas_system_retain (self);
	_tmp0_ = world;
	...
	((entitasSystem*) self)->execute = ___lambda13__entitas_system_execute;
	((entitasSystem*) self)->execute_target = block2_data_ref (_data2_);
	((entitasSystem*) self)->execute_target_destroy_notify = block2_data_unref;
